...
The only real addition that was added was Bootstrap, because it does a fantastic job with layouts right out of the box. Oh, and a set of 25 users from [Random User Generator](https://randomuser.me/), so useful.
